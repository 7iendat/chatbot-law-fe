...
const HomePage = () => {
    ...
    return (
        ...
        >
            ...
            {/* Main content - Welcome and Initial Input */}
            <div
                className={`flex-1 flex flex-col items-center justify-center p-4 md:p-6 h-full relative`} // <-- CẢI TIẾN 1: Thêm "relative"
            >
                {/* --- CẢI TIẾN 2: THÊM NÚT MENU CHO MOBILE --- */}
                <button
                    onClick={() => setShowSidebar(true)}
                    className={`absolute top-4 left-4 z-20 md:hidden p-2 rounded-md transition-colors ${
                        effectiveTheme === "light"
                            ? "hover:bg-gray-200"
                            : "hover:bg-gray-700"
                    }`}
                    ...
                    <div
                        className={`mt-12 w-full ${
                            ...
                            effectiveTheme === "light"
                                ? "border-gray-200"
                                : "border-gray-700"
                        } rounded-2xl shadow-2xl p-6 transition-all duration-300 hover:shadow-3xl`}
                    >
                        <textarea
                            value={initialInput}
                            onChange={(e) => setInitialInput(e.target.value)}
                            ...
                            placeholder="Nhập câu hỏi đầu tiên của bạn ở đây..."
                            rows={2}
                            className={`w-full border-2 rounded-xl px-5 py-4 focus:outline-none focus:ring-4 resize-none text-base transition-all duration-300 ${
                                effectiveTheme === "light"
                                    ? "bg-white/90 border-gray-200 focus:border-blue-400 focus:ring-blue-100"
